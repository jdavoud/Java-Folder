...
public class Battle {
	...
	private Boolean canChangeOptionNum = true; //Used so that you dont change the option num infinitely while holding it
	...
	public Boolean getCanChangeOptionNum(){
		return this.canChangeOptionNum;
	}
	public void setCanChangeOptionNum(Boolean canChange){
		this.canChangeOptionNum = canChange;
	}
}
